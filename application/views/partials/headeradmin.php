...
<head>
    ...
    <title>Dashboard - BanSehat Admin</title>
    <!-- Favicons -->
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">BanSehat</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav d-none d-md-inline-block  ms-auto me-0 me-md-3 my-2 my-md-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?= base_url('cadmin/logout') ?> "
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo base_url('cadmin/listOrder'); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            List Pemesanan
                        </a>
                        <div class="sb-sidenav-menu-heading">Akun</div>
                        <a class="nav-link" href="<?php echo base_url('cadmin/showData'); ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Mekanik
                        </a>
                    </div>
